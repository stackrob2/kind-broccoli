...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://f4d21d05c53e.ngrok.io/pull/5ffc16612abbc870d2f03e86
...
To start editing your site, you can use the Sanity interface at https://kind-broccoli-c1661.sanity.studio/.
...
Generated at `2021-01-11T09:12:15.885Z` by Stackbit version `0.3.42`.